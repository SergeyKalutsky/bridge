...
contextBridge.exposeInMainWorld('projects', {
    ...
    getFileBasename: ({ filepath }: { filepath: string }): Promise<string> => ipcRenderer.invoke('projects:getfilebasename', { filepath }),
...
contextBridge.exposeInMainWorld('git', {
    ...
    pull: (branch: string): Promise<void> => ipcRenderer.invoke('git:pull', branch),
    push: ({ branch, force }: { branch: string, force: boolean }): Promise<void> => ipcRenderer.invoke('git:push', { branch, force }),
