                ...
                <ToolBar>
                    <div className="w-full flex justify-end">
                        <div className="flex justify-between w-[150px] mr-10 h-1/5">
                            ...
                            <div className="flex">
                                <IconButton >
                                    <FaLongArrowAltDown style={{ color: 'white', height: 35, width: 30, textDecorationColor: 'white' }} />
                                </IconButton>
                                <IconButton >
                                    <FaLongArrowAltUp style={{ color: 'white', height: 35, width: 30, textDecorationColor: 'white' }} />
                                </IconButton>
                            </div>
                        </div>
                    </div>
