...
const Button = ({ children, btnText, onClick, disabled }: Props): JSX.Element => {
    ...
    return (
        <button disabled={disabled}
            className={`w-32 h-10 bg-sky-800 ${disabledStyle} rounded-md text-gray-200 font-medium text-xl focus:outline-none flex flex-row justify-center items-center`}
            onClick={onClick}
